...
- If this change edited a document with a `.ko.md` companion, update the companion in the same change (`ADR-0005`) — a stale translation is a defect, not a follow-up task.
